...
void dma_init(void *bufferStart) {
	...
	//DMAC->CHINTENSET.reg = DMAC_CHINTENSET_TCMPL; //DMAC_CHINTENSET_MASK ;							//Enable all 3 interrupts Channel Suspend, Channel Transfer Complete and Channel Transfer Error
	...
	descriptor.btcnt =  1022;												//Number of beats to transfer (1024)
	...
	descriptor.srcaddr += 1022;												//For some reason we have to set this to the end of data bank
